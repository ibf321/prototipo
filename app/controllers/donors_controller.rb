class DonorsController < ApplicationController
  ...
  private
    ...
    def donor_params
      params.require(:donor).permit(:situation, :social_name, :fantasy_name, :type_doner, :cnpj_namber, :cpf, :legal_responsible, :rg_responsible, :cpf_responsible, :registration_date, :address, :district, :city, :complement, :email, :activity, :phone, :withdrawal_day, :obs)
    end
end
